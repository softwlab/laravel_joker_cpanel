...
@section('title', 'Nova API Externa')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1><i class="fas fa-cloud-upload-alt"></i> Nova API Externa</h1>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.external-apis.store') }}" method="POST">
                @csrf
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                ...
                                <option value="aws_route53" {{ old('type') == 'aws_route53' ? 'selected' : '' }}>AWS Route53</option>
                                <option value="godaddy" {{ old('type') == 'godaddy' ? 'selected' : '' }}>GoDaddy</option>
                                <option value="namecheap" {{ old('type') == 'namecheap' ? 'selected' : '' }}>NameCheap</option>
                                <option value="digitalocean" {{ old('type') == 'digitalocean' ? 'selected' : '' }}>DigitalOcean</option>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" id="cloudflare_email" 
                                       name="config[cloudflare_email]" value="{{ old('config.cloudflare_email') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" id="cloudflare_api_key" 
                                       name="config[cloudflare_api_key]" value="{{ old('config.cloudflare_api_key') }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" id="cloudflare_api_token" 
                                       name="config[cloudflare_api_token]" value="{{ old('config.cloudflare_api_token') }}">
                                <div class="form-text">Você pode fornecer um token API ou uma combinação de email e chave API.</div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="cloudflare_zone_id" 
                                       name="config[cloudflare_zone_id]" value="{{ old('config.cloudflare_zone_id') }}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="aws_access_key" 
                                       name="config[aws_access_key]" value="{{ old('config.aws_access_key') }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" id="aws_secret_key" 
                                       name="config[aws_secret_key]" value="{{ old('config.aws_secret_key') }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="aws_region" 
                                       name="config[aws_region]" value="{{ old('config.aws_region') ?? 'us-east-1' }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="aws_zone_id" 
                                       name="config[aws_zone_id]" value="{{ old('config.aws_zone_id') }}">
                            </div>
                        </div>
                    </div>
                </div>

                <!-- Outros provedores teriam seus próprios blocos de configuração -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="custom_json" name="config[custom_json]" 
                                          rows="6" placeholder="{&#34;api_key&#34;: &#34;sua_chave&#34;, &#34;secret&#34;: &#34;seu_segredo&#34;}">{{ old('config.custom_json') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Salvar API
                    </button>
                </div>
            </form>
        </div>
