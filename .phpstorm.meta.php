...
'scribe.strategies.responses.5.1.cookies','scribe.strategies.responseFields','scribe.database_connections_to_transact','scribe.fractal.serializer','services.postmark.token',
...
'scribe','scribe.postman','scribe.openapi','login','logout','dashboard',
...
'cliente.templates.config.update','cliente.linkgroups.index','cliente.linkgroups.create','cliente.linkgroups.store','cliente.linkgroups.show',
'cliente.linkgroups.edit','cliente.linkgroups.update','cliente.linkgroups.destroy','cliente.linkgroups.items.store','cliente.linkgroups.items.update',
'cliente.linkgroups.items.destroy','cliente.linkgroups.items.reorder','cliente.visitantes.index','cliente.visitantes.show','cliente.informacoes.index',
'cliente.informacoes.show','cliente.estatisticas.index','cliente.estatisticas.filtrar','admin.dashboard','admin.external-apis.index',
'admin.external-apis.create','admin.external-apis.store','admin.external-apis.show','admin.external-apis.edit','admin.external-apis.update',
'admin.external-apis.destroy','admin.external-apis.domains','admin.external-apis.create-record','admin.external-apis.update-ghost','admin.domains.ghost-info',
'admin.','admin.','admin.users','admin.users.create','admin.users.store',
'admin.users.show','admin.users.edit','admin.users.update','admin.users.destroy','admin.banks',
'admin.banks.create','admin.banks.store','admin.banks.show','admin.banks.edit','admin.banks.update',
'admin.banks.destroy','admin.cloudflare.domain-associations.index','admin.cloudflare.domain-associations.create','admin.cloudflare.domain-associations.store','admin.cloudflare.domain-associations.show',
'admin.cloudflare.domain-associations.edit','admin.cloudflare.domain-associations.update','admin.cloudflare.domain-associations.destroy','admin.logs','admin.templates.index',
...
'admin.dns-records.sync','admin.dns-records.sync-record','admin.domains.records','admin.domains.sync','admin.linkgroups.index',
'admin.linkgroups.create','admin.linkgroups.store','admin.linkgroups.show','admin.linkgroups.edit','admin.linkgroups.update',
'admin.linkgroups.destroy','storage.local',);
...
'admin.external-apis.index','admin.external-apis.show','admin.linkgroups.create','admin.linkgroups.edit','admin.linkgroups.index',
'admin.linkgroups.show','admin.logs','admin.templates.create','admin.templates.edit','admin.templates.index',
'admin.user-details','admin.users','auth.login','cliente.all-templates','cliente.bank-details',
'cliente.bank-details-new','cliente.banks','cliente.create-bank','cliente.dashboard','cliente.domain-templates',
'cliente.estatisticas.index','cliente.informacoes.index','cliente.informacoes.show','cliente.linkgroups.show','cliente.profile',
'cliente.template-config','cliente.visitantes.index','cliente.visitantes.show','layouts.admin','layouts.admin-sidebar',
'layouts.app','layouts.client-sidebar','layouts.cliente','linkgroups.create','linkgroups.edit',
'linkgroups.index','linkgroups.show','scribe.index','welcome','laravel-exceptions-renderer::components.card',
