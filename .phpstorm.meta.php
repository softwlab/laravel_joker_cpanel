...
'debugbar.route_middleware','debugbar.route_domain','debugbar.theme','debugbar.debug_backtrace_limit','deprecation.start_date',
'deprecation.warning_date','deprecation.end_date','deprecation.log_retention_days','deprecation.migration_docs_url','filesystems.default',
...
'filesystems.disks.s3.report','filesystems.links.C:\\Projetos\\jokerlab_cpanel\\public\\storage','larecipe.docs.route','larecipe.docs.path','larecipe.docs.landing',
...
'logging.channels.errorlog.replace_placeholders','logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','logging.channels.deprecated_api.driver',
'logging.channels.deprecated_api.path','logging.channels.deprecated_api.level','logging.channels.deprecated_api.days','logging.channels.deprecations.driver','logging.channels.deprecations.handler',
...
'scribe.postman.overrides','scribe.openapi.enabled','scribe.openapi.overrides','scribe.openapi.generators','scribe.groups.default',
...
'hashing.rehash_on_login','view.paths','view.compiled','migrations-generator.migration_template_path','migrations-generator.migration_target_path',
...
'debugbar.queries.explain','larecipe.search','larecipe.styles','larecipe.scripts','scribe',
'larecipe.show','scribe.postman','scribe.openapi','login','logout',
'dashboard','cliente.dashboard','cliente.profile','cliente.profile.update','cliente.banks',
'cliente.banks.create','cliente.banks.store','cliente.banks.show','cliente.banks.update','cliente.banks.destroy',
'cliente.templates.config','cliente.templates.config.update','cliente.visitantes.index','cliente.visitantes.show','cliente.subscriptions.index',
'cliente.subscriptions.show','cliente.informacoes.index','cliente.informacoes.show','cliente.estatisticas.index','cliente.estatisticas.filtrar',
'admin.dashboard','admin.external-apis.index','admin.external-apis.create','admin.external-apis.store','admin.external-apis.show',
'admin.external-apis.edit','admin.external-apis.update','admin.external-apis.destroy','admin.external-apis.domains','admin.external-apis.update-ghost',
'admin.domains.ghost-info','admin.external-apis.create-record','admin.external-apis.store-record','admin.external-apis.delete-record','admin.external-apis.test-connection',
'admin.external-apis.edit-config','admin.external-apis.update-config','admin.','admin.','admin.users',
'admin.users.create','admin.users.store','admin.users.show','admin.users.edit','admin.users.update',
'admin.users.destroy','admin.users.dns','admin.users.cloudflare','admin.banks','admin.banks.create',
...
'admin.cloudflare.domain-associations.update','admin.cloudflare.domain-associations.destroy','admin.logs','admin.subscriptions.index','admin.subscriptions.create',
'admin.subscriptions.store','admin.subscriptions.show','admin.subscriptions.edit','admin.subscriptions.update','admin.subscriptions.destroy',
'admin.reports.deprecated-api','admin.templates.index','admin.templates.create','admin.templates.store','admin.templates.edit',
'admin.templates.update','admin.templates.destroy','admin.templates.add-field','admin.templates.update-field','admin.templates.delete-field',
'admin.templates.reorder-fields','admin.api_keys.index','admin.api_keys.create','admin.api_keys.store','admin.api_keys.show',
'admin.api_keys.edit','admin.api_keys.update','admin.api_keys.destroy','admin.api_keys.regenerate','admin.dns-record-template-fields.index',
'admin.dns-record-template-fields.create','admin.dns-record-template-fields.store','admin.dns-record-template-fields.show','admin.dns-record-template-fields.edit','admin.dns-record-template-fields.update',
'admin.dns-record-template-fields.destroy','admin.','admin.','admin.dns-records.index','admin.dns-records.create',
'admin.dns-records.store','admin.dns-records.show','admin.dns-records.edit','admin.dns-records.update','admin.dns-records.destroy',
'admin.dns-records.sync','admin.dns-records.sync-record','admin.dns-records.force-update-template','admin.domains.records','admin.domains.sync',
'storage.local',);
...
'cliente.record-templates','cliente.subscriptions.index','cliente.subscriptions.show','cliente.template-config','cliente.visitantes.index',
'cliente.visitantes.show','larecipe::partials.404','larecipe::partials.logo','larecipe::partials.nav','larecipe::partials.sidebar',
'layouts.admin','layouts.admin-sidebar','layouts.app','layouts.client-sidebar','layouts.cliente',
'scribe.index','vendor.larecipe.partials.404','vendor.larecipe.partials.logo','vendor.larecipe.partials.nav','vendor.larecipe.partials.sidebar',
...
'laravel-exceptions::minimal','larecipe::default','larecipe::docs','larecipe::partials.404','larecipe::partials.logo',
'larecipe::partials.nav','larecipe::partials.sidebar','larecipe::plugins.forum','larecipe::plugins.search','larecipe::style',
