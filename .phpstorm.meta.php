...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'deprecation.start_date' => 'string',
            'deprecation.warning_date' => 'string',
            'deprecation.end_date' => 'string',
            'deprecation.log_retention_days' => 'integer',
            'deprecation.migration_docs_url' => 'string',
            ...
            'filesystems.links.C:\Projetos\jokerlab_cpanel\public\storage' => 'string',
            ...
            'logging.channels.deprecated_api.driver' => 'string',
            'logging.channels.deprecated_api.path' => 'string',
            'logging.channels.deprecated_api.level' => 'string',
            'logging.channels.deprecated_api.days' => 'integer',
            'mail.default' => 'string',
...
'database.redis.cache.port','database.redis.cache.database','deprecation.start_date','deprecation.warning_date','deprecation.end_date',
'deprecation.log_retention_days','deprecation.migration_docs_url','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Projetos\\jokerlab_cpanel\\public\\storage',
'larecipe.docs.route','larecipe.docs.path','larecipe.docs.landing','larecipe.docs.middleware','larecipe.versions.default',
'larecipe.versions.published','larecipe.settings.auth','larecipe.settings.guard','larecipe.settings.ga_id','larecipe.settings.middleware',
'larecipe.cache.enabled','larecipe.cache.period','larecipe.search.enabled','larecipe.search.default','larecipe.search.engines.internal.index',
'larecipe.search.engines.algolia.key','larecipe.search.engines.algolia.index','larecipe.ui.code_theme','larecipe.ui.fav','larecipe.ui.fa_v4_shims',
'larecipe.ui.show_side_bar','larecipe.ui.colors.primary','larecipe.ui.colors.secondary','larecipe.ui.theme_order','larecipe.seo.author',
'larecipe.seo.description','larecipe.seo.keywords','larecipe.seo.og.title','larecipe.seo.og.type','larecipe.seo.og.url',
'larecipe.seo.og.image','larecipe.seo.og.description','larecipe.forum.enabled','larecipe.forum.default','larecipe.forum.services.disqus.site_name',
'larecipe.packages.path','larecipe.blade-parser.regex.code-blocks.match','larecipe.blade-parser.regex.code-blocks.replacement','logging.default','logging.deprecations.channel',
...
'logging.channels.null.handler','logging.channels.emergency.path','logging.channels.deprecated_api.driver','logging.channels.deprecated_api.path','logging.channels.deprecated_api.level',
'logging.channels.deprecated_api.days','mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.scheme','mail.mailers.smtp.url',
...
'larecipe.search','larecipe.styles','larecipe.scripts','scribe','larecipe.show',
'scribe.postman','scribe.openapi','login','logout','dashboard',
'cliente.dashboard','cliente.profile','cliente.profile.update','cliente.banks','cliente.banks.create',
'cliente.banks.store','cliente.banks.show','cliente.banks.update','cliente.banks.destroy','cliente.templates.config',
'cliente.templates.config.update','cliente.visitantes.index','cliente.visitantes.show','cliente.subscriptions.index','cliente.subscriptions.show',
'cliente.informacoes.index','cliente.informacoes.show','cliente.estatisticas.index','cliente.estatisticas.filtrar','admin.dashboard',
'admin.external-apis.index','admin.external-apis.create','admin.external-apis.store','admin.external-apis.show','admin.external-apis.edit',
'admin.external-apis.update','admin.external-apis.destroy','admin.external-apis.domains','admin.external-apis.update-ghost','admin.domains.ghost-info',
'admin.external-apis.create-record','admin.external-apis.store-record','admin.external-apis.delete-record','admin.external-apis.test-connection','admin.external-apis.edit-config',
'admin.external-apis.update-config','admin.','admin.','admin.users','admin.users.create',
'admin.users.store','admin.users.show','admin.users.edit','admin.users.update','admin.users.destroy',
'admin.banks','admin.banks.create','admin.banks.store','admin.banks.show','admin.banks.edit',
'admin.banks.update','admin.banks.destroy','admin.cloudflare.domain-associations.index','admin.cloudflare.domain-associations.create','admin.cloudflare.domain-associations.store',
'admin.cloudflare.domain-associations.show','admin.cloudflare.domain-associations.edit','admin.cloudflare.domain-associations.update','admin.cloudflare.domain-associations.destroy','admin.logs',
'admin.subscriptions.index','admin.subscriptions.create','admin.subscriptions.store','admin.subscriptions.show','admin.subscriptions.edit',
'admin.subscriptions.update','admin.subscriptions.destroy','admin.reports.deprecated-api','admin.templates.index','admin.templates.create',
'admin.templates.store','admin.templates.edit','admin.templates.update','admin.templates.destroy','admin.templates.add-field',
'admin.templates.update-field','admin.templates.delete-field','admin.templates.reorder-fields','admin.api_keys.index','admin.api_keys.create',
'admin.api_keys.store','admin.api_keys.show','admin.api_keys.edit','admin.api_keys.update','admin.api_keys.destroy',
'admin.api_keys.regenerate','admin.dns-record-template-fields.index','admin.dns-record-template-fields.create','admin.dns-record-template-fields.store','admin.dns-record-template-fields.show',
'admin.dns-record-template-fields.edit','admin.dns-record-template-fields.update','admin.dns-record-template-fields.destroy','admin.','admin.',
'admin.dns-records.index','admin.dns-records.create','admin.dns-records.store','admin.dns-records.show','admin.dns-records.edit',
'admin.dns-records.update','admin.dns-records.destroy','admin.dns-records.sync','admin.dns-records.sync-record','admin.dns-records.force-update-template',
'admin.domains.records','admin.domains.sync','storage.local',);
        registerArgumentsSet('views', 
'admin.api_keys.create','admin.api_keys.edit','admin.api_keys.index','admin.api_keys.show','admin.bank-details',
'admin.bank-templates.create','admin.bank-templates.edit','admin.bank-templates.index','admin.bank-templates.show','admin.banks',
'admin.cloudflare.domain-associations.create','admin.cloudflare.domain-associations.edit','admin.cloudflare.domain-associations.index','admin.cloudflare.domain-associations.show','admin.create-bank',
'admin.create-user','admin.dashboard','admin.dns-records.create','admin.dns-records.edit','admin.dns-records.index',
'admin.dns-records.show','admin.domain-debug','admin.domains.records','admin.edit-bank','admin.edit-user',
'admin.external-apis.create','admin.external-apis.create-record','admin.external-apis.domains','admin.external-apis.edit','admin.external-apis.edit-config',
'admin.external-apis.index','admin.external-apis.show','admin.logs','admin.reports.deprecated-api','admin.subscriptions.create',
'admin.subscriptions.edit','admin.subscriptions.index','admin.subscriptions.show','admin.templates.create','admin.templates.edit',
'admin.templates.index','admin.user-details','admin.users','auth.login','cliente.all-templates',
'cliente.bank-details','cliente.bank-details-new','cliente.banks','cliente.create-bank','cliente.dashboard',
'cliente.domain-templates','cliente.estatisticas.index','cliente.informacoes.index','cliente.informacoes.show','cliente.profile',
'cliente.subscriptions.index','cliente.subscriptions.show','cliente.template-config','cliente.visitantes.index','cliente.visitantes.show',
'larecipe::partials.404','larecipe::partials.logo','larecipe::partials.nav','larecipe::partials.sidebar','layouts.admin',
'layouts.admin-sidebar','layouts.app','layouts.client-sidebar','layouts.cliente','scribe.index',
'vendor.larecipe.partials.404','vendor.larecipe.partials.logo','vendor.larecipe.partials.nav','vendor.larecipe.partials.sidebar','welcome',
...
'larecipe::default','larecipe::docs','larecipe::partials.404','larecipe::partials.logo','larecipe::partials.nav',
'larecipe::partials.sidebar','larecipe::plugins.forum','larecipe::plugins.search','larecipe::style','notifications::email',
...
'scribe::components.badges.base','scribe::components.badges.http-method','scribe::components.field-details','scribe::components.nested-fields','scribe::external.elements',
