...
'cliente.templates.config.update','cliente.visitantes.index','cliente.visitantes.show','cliente.informacoes.index','cliente.informacoes.show',
'cliente.estatisticas.index','cliente.estatisticas.filtrar','admin.dashboard','admin.external-apis.index','admin.external-apis.create',
'admin.external-apis.store','admin.external-apis.show','admin.external-apis.edit','admin.external-apis.update','admin.external-apis.destroy',
'admin.external-apis.domains','admin.external-apis.create-record','admin.external-apis.update-ghost','admin.domains.ghost-info','admin.',
'admin.','admin.users','admin.users.create','admin.users.store','admin.users.show',
'admin.users.edit','admin.users.update','admin.users.destroy','admin.banks','admin.banks.create',
'admin.banks.store','admin.banks.show','admin.banks.edit','admin.banks.update','admin.banks.destroy',
'admin.cloudflare.domain-associations.index','admin.cloudflare.domain-associations.create','admin.cloudflare.domain-associations.store','admin.cloudflare.domain-associations.show','admin.cloudflare.domain-associations.edit',
'admin.cloudflare.domain-associations.update','admin.cloudflare.domain-associations.destroy','admin.logs','admin.reports.deprecated-api','admin.templates.index',
'admin.templates.create','admin.templates.store','admin.templates.edit','admin.templates.update','admin.templates.destroy',
'admin.templates.add-field','admin.templates.update-field','admin.templates.delete-field','admin.templates.reorder-fields','admin.external-apis.create-record',
'admin.external-apis.store-record','admin.external-apis.delete-record','admin.external-apis.test-connection','admin.api_keys.index','admin.api_keys.create',
'admin.api_keys.store','admin.api_keys.show','admin.api_keys.edit','admin.api_keys.update','admin.api_keys.destroy',
'admin.api_keys.regenerate','admin.external-apis.edit-config','admin.external-apis.update-config','admin.dns-records.index','admin.dns-records.create',
'admin.dns-records.store','admin.dns-records.show','admin.dns-records.edit','admin.dns-records.update','admin.dns-records.destroy',
'admin.dns-records.sync','admin.dns-records.sync-record','admin.domains.records','admin.domains.sync','storage.local',);
...
'admin.external-apis.index','admin.external-apis.show','admin.logs','admin.reports.deprecated-api','admin.templates.create',
'admin.templates.edit','admin.templates.index','admin.user-details','admin.users','auth.login',
'cliente.all-templates','cliente.bank-details','cliente.bank-details-new','cliente.banks','cliente.create-bank',
'cliente.dashboard','cliente.domain-templates','cliente.estatisticas.index','cliente.informacoes.index','cliente.informacoes.show',
'cliente.profile','cliente.template-config','cliente.visitantes.index','cliente.visitantes.show','larecipe::partials.404',
'larecipe::partials.logo','larecipe::partials.nav','larecipe::partials.sidebar','layouts.admin','layouts.admin-sidebar',
'layouts.app','layouts.client-sidebar','layouts.cliente','scribe.index','vendor.larecipe.partials.404',
'vendor.larecipe.partials.logo','vendor.larecipe.partials.nav','vendor.larecipe.partials.sidebar','welcome','laravel-exceptions-renderer::components.card',
...
'laravel-exceptions::500','laravel-exceptions::503','laravel-exceptions::layout','laravel-exceptions::minimal','larecipe::default',
'larecipe::docs','larecipe::partials.404','larecipe::partials.logo','larecipe::partials.nav','larecipe::partials.sidebar',
'larecipe::plugins.forum','larecipe::plugins.search','larecipe::style','notifications::email','pagination::bootstrap-4',
